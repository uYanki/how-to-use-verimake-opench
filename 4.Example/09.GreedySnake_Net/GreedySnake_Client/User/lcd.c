...
void lcd_gpio_init(void)
{
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD | RCC_APB2Periph_GPIOB | RCC_APB2Periph_TIM1, ENABLE);
...
void lcd_init(void)
{
    ...
    id = lcd_read_data();      //����0X85
    id = lcd_read_data();      //��ȡ0X85
    id <<= 8;
    id |= lcd_read_data();     //��ȡ0X52
